...
const TABLE_HEAD = [
    ...
    { id: 'c_id', label: 'Url', alignRight: false },
...
export default function Employees() {
    ...
    const UpdatePopUpSubmitData = async (e) => {
        ...
        formData.append("change_tittle", "portal");
        formData.append("portal_url", PopUpstate.portal_url);
                ...
                <Scrollbar>
                    <TableContainer sx={{ minWidth: 800 }}>
                        <Table>
                            ...
                            />
                            {state &&
                                state[0].employee_portals?.map((ele, i) => {
                                    return (<>
                                        <TableBody>
                                            <TableRow
                                            >
