...
export default function Experience(props) {
    ...
    const UpdatePopUpSubmitData = async (e) => {
        ...
        setupdateModelopen(false)
        await axios
            .put(`${baseUrlPostGres()}/api/training-experience-update`, formData, {
                headers: apiHeader()
            })
            .then(response => {
    ...
    const listCalling = () => {
        axios
            .get(`${baseUrlPostGres()}/api/training-experience-list`, {
                headers: apiHeader()
            })
            .then(response => {
              if(response.data.message==="Unauthorized please login again!"){
    ...
    const ADDPopUpSubmitData = async () => {
        ...
        if (PopUpstate?.description && PopUpstate?.image && PopUpstate?.tittle && PopUpstate?.total_value) {
            ...
            setopen(false)
            await axios
                .post(`${baseUrlPostGres()}/api/training-experience-add`, formData, {
                    headers: apiHeader()
                })
                .then(response => {
              if(response.data.message==="Unauthorized please login again!"){
    ...
    const openhandleDeleteModel = async (ele) => {
        ...
        setopen(false)
        await axios.delete(`${baseUrlPostGres()}/api/training-experience-delete/${ele.id}`, {
            headers: apiHeader()
        })
            .then(response => {
              if(response.data.message==="Unauthorized please login again!"){
