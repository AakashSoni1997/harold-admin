...
const ExperienceSection = (props) => {
  ...
  const experienceList=useSelector((state)=>state.logistics?.logistics_experience_list?.success);
  const updateData=useSelector((state)=>state.logistics?.logistics_experience_update);
  const addData=useSelector((state)=>state.logistics?.logistics_experience_add);
  console.log(addData,"addDataaaaaaaaaa");
  ...
  useEffect(() => {
    dispatch(GetLogisticsExperienceList());
  ...
  const UpdatePopUpSubmitData = async (e) => {
    ...
    let formData = new FormData();
      ...
      setupdateModelopen(false);
      dispatch(UpdateLogisticsExperience(formData))
  ...
  const ADDPopUpSubmitData = async () => {
    ...
    if (PopUpstate?.description && PopUpstate?.image && PopUpstate?.tittle && PopUpstate?.total_value) {
      ...
      formData.append("total_value", PopUpstate.total_value);
      setopen(false);
      dispatch(AddLogisticsExperience(formData))
    } else {
  ...
  const openhandleDeleteModel = async (ele) => {
    ...
    setopen(false);
    dispatch(DeleteLogisticsExperience(ele.id))
  };
