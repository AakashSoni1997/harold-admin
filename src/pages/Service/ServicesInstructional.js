...
import {
  GetServicesAdministrativeList,
  UpdateServicesAdministrativeList,
  GetServicesInstructionalList,
  UpdateServicesInstructionalList
...
export const ServicesInstructional = (props) => {
  ...
  const InstructionalList = useSelector(
    (state) => state.services?.services_instructional_list?.success,
  );
  const updateData = useSelector(
    (state) => state.services?.services_instructional_update,
  );

  useEffect(() => {
    setState(InstructionalList);
  }, [InstructionalList]);

  useEffect(() => {
    dispatch(GetServicesInstructionalList());
  }, [dispatch, updateData]);
  ...
  const UpdatePopUpSubmitData = async (e) => {
    ...
    setupdateModelopen(false);
    dispatch(UpdateServicesInstructionalList(formData));
  };
