...
import { GetContactCMSListAction } from 'src/redux/actions/MatchAction';
...
export default function UpcomingMatches(props) {
    ...
    const ContactCMSListData = useSelector(state => state.matches.contact_cms_list.data?.success)
    ...
    useEffect(() => {
        dispatch(GetContactCMSListAction())
    }, [])
